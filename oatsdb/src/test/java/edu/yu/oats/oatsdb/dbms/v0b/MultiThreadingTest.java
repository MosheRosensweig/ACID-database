...
public class MultiThreadingTest
{
    ...
    private final static boolean vPrintName = false;
    ...
    {
        if (vPrintName) logger.debug("tx2AttemptToGetResourceTx1Has2");
        setPrintNote(false);
    ...
    {
        if (vPrintName) logger.debug("txTwoWakesUpAfterTx1IsDone");
        setPrintNote(false);
