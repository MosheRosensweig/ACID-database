...
public class TxMgrImplTest
{
    ...
    {
        try {//test that a change updates the sytem properly
            TxMgrImpl.Instance.begin();
    ...
    @Test
    public void changeStuffButItWontMatter1()
    {
        Integer sam = 55;
        try {
            theTxMgr.begin();
            Map<String, Integer> map = DBMSImpl.Instance.createMap("changeStuffButItWontMatter1", String.class, Integer.class);
            map.put("Sam", sam);
            theTxMgr.commit();
            sam = 44;
            theTxMgr.begin();
            Map<String, Integer> map1 = theDBMS.getMap("changeStuffButItWontMatter1", String.class, Integer.class);
            //System.out.println("New Sam = "+map1.get("Sam"));
            //System.out.println("Old Sam = "+sam);
            assertNotEquals(map1.get("Sam"),sam );
            theTxMgr.commit();
        } catch (NotSupportedException e) {
            e.printStackTrace();
        } catch (SystemException e) {
